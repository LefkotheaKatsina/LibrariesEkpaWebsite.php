...
<body id="body">
    <div id="allcontent" class="borderDesign">
        ...
        <div class="mainSecondaryPage borderDesign3">
            ...
            <h2>Αναζήτηση Βιβλιοθήκης Αλφαβητικά</h2>
            <img class="image imageDesign pull-left" src="images/alphabhtika.jpg" width="160" height="98">
            <p class="paragraph">
                Το σύνολο των βιβλιοθηκών του Εθνικού και Καποδιστριακού Πανεπιστημίου Αθηνών είναι <b>47 Βιβλιοθήκες</b>. Παρακάτω παρουσιάζονται αυτές οι Βιβλιοθήκες, 
                οργανωμένες ανά αλφαβητική σειρά και ανά ομάδες γραμμάτων.<br>Αν επιθυμείτε σύνθετη Aναζήτηση Βιβλιοθήκης, ανατρέξτε στον αντίστοιχο σύνδεσμο 
            ...
            <div class="col-xs-3 alphaTabsPlace"> 
                <ul id="tabLibsMain" class="nav nav-tabs tabs-left tabsClass ">
                    <li class="active"><a href="#ΑΒ" data-toggle="tab">Α, B</a></li>
                    <li><a href="#ΔΕ" data-toggle="tab">Δ, Ε</a></li>
                    <li><a href="#ΘΙ" data-toggle="tab">Θ, Ι</a></li>
                    <li><a href="#ΜΝΟ" data-toggle="tab">Μ, Ν, Ο</a></li>
                    <li><a href="#ΠΥ" data-toggle="tab">Π, Υ</a></li>
                    <li><a href="#ΦΨ" data-toggle="tab">Φ, Ψ</a></li>
                </ul>
            </div>
            <div class="rightElement3">
                <div class="tab-content beforePager HoursBoxSecondaryPages borderDesign3">
                    <div class="contents tab-pane tab-paneClass active" id="ΑΒ">
                        ...
                        <div>
                            ...
                            <div class="middleInfo">
                                ...
                                <p class="address"><b>Διεύθυνση:<br></b>Πανεπιστημιούπολη,<br>Ζωγράφου</p>
                            </div>
                    ...
                    <div class="contents tab-pane tab-paneClass" id="ΔΕ">
                        <div class="libraryHours">
                            <table class="rightInfo">
                    ...
                    <div class="contents tab-pane tab-paneClass" id="ΘΙ">
                        <div class="libraryHours">
                            <table class="rightInfo">
                                <tr><th>Τηλέφωνο: <span class="glyphicon glyphicon-phone"></span></th><td>(210) 7275 781</td></tr>
                                <tr><th>Email: <span class="glyphicon glyphicon-envelope"></span></th><td>blablabla.edu.uoa.gr</td></tr>
                    ...
                    <div class="contents tab-pane tab-paneClass" id="ΜΝΟ">
                        <div class="libraryHours">
                            <table class="rightInfo">
                            ...
                            <div class="middleInfo">
                                ...
                                <p class="address"><b>Διεύθυνση:<br></b>Πανεπιστημιόπολη, Ζωγράφου</p>
                            </div>
                            <table class="hoursTable tableDesign hoursTablePlace1">
                                <tr>
                                    <th class="tableHeader">
                    ...
                    <div class="contents tab-pane tab-paneClass" id="ΠΥ">
                        <div class="libraryHours">
                            <table class="rightInfo">
                    ...
                    <div class="contents tab-pane tab-paneClass" id="ΦΨ">
                        <div class="libraryHours">
                            <table class="rightInfo">
